...
export default function FriendsPanel() {
	return (
		<aside className="hidden xl:block bg-card border-2 border-br-card rounded-lg h-full w-full flex-1">
			<div className="flex flex-col h-full">
				...
				<div className="overflow-y-auto flex-1 max-h-[calc(100vh-19rem)]">
