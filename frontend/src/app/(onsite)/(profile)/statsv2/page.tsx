				...
				<div className={`px-10 ${funnelDisplay.className} flex flex-col gap-4`}>
					...
					<section className='grid gap-4 lg:grid-cols-2 xl:grid-cols-4'>
						...
						<div className='flex flex-col gap-2'>
							...
							/>
							<StatCard
								title="Today Average Score"
								value="12.1"
								subtitle="+29% than yesterday"
								subtitleColor="text-blue-500"
								icon={<TrendingUp size={20} />}
							/>
						</div>
					...
					<section className='grid gap-4 lg:grid-cols-2 xl:grid-cols-4'>
						...
						<div className='flex flex-col gap-2'>
							...
							/>
							<StatCard
								title="Today Average Duration"
								value="5m"
								subtitle="+3% than yesterday"
								subtitleColor="text-blue-500"
								icon={<TrendingUp size={20} />}
							/>
						</div>
					...
					{/* <section className='grid gap-4 lg:grid-cols-3'> */}
						{/* <StatsCardV1
							...
							items={[
								{ label: "Per Win", value: 18.2 },
								{ label: "Per Loss", value: 8.4 },
								{ label: "Per Draw", value: 12.1 }
							]}
						/> */}
					{/* </section> */}
