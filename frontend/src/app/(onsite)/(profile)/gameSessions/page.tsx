...
import { ChartCard, StatCard } from "../statsv1/page";
...
// export default function GameSessionsDashboard() {
// 	return (
// 		<main
...
// 					<div className={`pl-8 pr-8 flex h-full flex-col gap-10 pb-4 ${funnelDisplay.className}`}>
// 						{/* UPPER CARD */}
// 						<div className='flex flex-col gap-4 2xl:flex-row'>
// 							<div className='flex flex-col gap-4 md:flex-row flex-1'>
// 								{/* CARD */}
// 								<div className='bg-white/4 border border-white/10  w-full rounded-2xl backdrop-blur-2xl px-4 py-3
// 												flex flex-col gap-7 flex-1'>
// 									<div className='flex items-center justify-between'>
// 										<p className='font-bold text-xl'>Today&#39;s Games</p>
// 										{/* <ClockFading size={20} className=''/> */}
// 									</div>
// 									<div className='flex items-end justify-between'>
// 										<p className='font-extrabold text-3xl'>6</p>
// 										<p className='text-sm text-green-500'>3 wins / 2 losses</p>
// 									</div>
// 								</div>
// 								{/* END */}
// 								{/* CARD */}
...
// 												flex flex-col gap-7 flex-1'>
// 									<div className='flex items-center justify-between'>
// 										<p className='font-bold text-xl'>Avg Session Time</p>
// 										{/* <Medal size={20} className=''/> */}
// 									</div>
// 									<div className='flex items-end justify-between'>
// 										<p className='font-extrabold text-3xl'>11:42</p>
// 										<p className='text-sm text-blue-500'>minutes per game</p>
// 									</div>
// 								</div>
// 								{/* END */}
// 							</div>
...
// 												flex flex-col gap-7 flex-1'>
// 									<div className='flex items-center justify-between'>
// 										<p className='font-bold text-xl'>Highest Score Today</p>
// 										{/* <HeartCrack size={20} className=''/> */}
// 									</div>
// 									<div className='flex items-end justify-between'>
// 										<p className='font-extrabold text-3xl'>15</p>
// 										<p className='text-sm text-green-500'>vs iassil</p>
// 									</div>
// 								</div>
// 								{/* END */}
// 								{/* CARD */}
...
// 												flex flex-col gap-7 flex-1'>
// 									<div className='flex items-center justify-between'>
// 										<p className='font-bold text-xl'>Opponents Faced</p>
// 										{/* <Heart size={20} className=''/> */}
// 									</div>
// 									<div className='flex items-end justify-between'>
// 										<p className='font-extrabold text-3xl'>5</p>
// 										<p className='text-sm text-blue-500'>unique players</p>
// 									</div>
// 								</div>
// 								{/* END */}
// 							</div>
...
// 							<div className='bg-white/4 border border-white/10 w-full rounded-2xl backdrop-blur-2xl px-4 py-3 min-h-78 overflow-hidden
// 											flex-2'>
// 								<h1 className='font-bold text-xl'>Game Type Distribution</h1>
// 								<p className='text-sm text-violet-400'>Ping Pong vs XO over all time</p>
// 								<ChartPie data={gameTypeDistData} nameKey='type' dataKey='percent' unit='%' />
// 							</div>
// 							<div className='bg-white/4 border border-white/10 w-full rounded-2xl backdrop-blur-2xl px-4 py-3 min-h-78 overflow-hidden
// 											flex-2'>
// 								<h1 className='font-bold text-xl'>Game Mode Distribution</h1>
// 								<p className='text-sm text-violet-400'>Casual vs 1v1 vs Tournament vs Training over all time</p>
// 								<ChartPie data={gameModeDistData} nameKey='type' dataKey='percent' unit='%' />
// 							</div>
// 						</div>
...
// 						<div className='flex flex-col gap-4 w-full lg:flex-row'>
// 							<div className='bg-white/4 border border-white/10 w-full rounded-2xl backdrop-blur-2xl px-4 py-3 overflow-hidden
// 											flex-2'>
// 								<h1 className='font-bold text-xl mb-4'>Match Outcomes</h1>
// 								<div className="flex flex-col gap-1">
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Wins</p>
// 										<p className='font-extrabold text-xl text-green-400'>56</p>
// 									</div>
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Losses</p>
// 										<p className='font-extrabold text-xl text-red-400'>22</p>
// 									</div>
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Win Rate</p>
// 										<p className='font-extrabold text-xl text-white/90'>73.6%</p>
// 									</div>
// 								</div>
// 							</div>
// 							<div className='bg-white/4 border border-white/10 w-full rounded-2xl backdrop-blur-2xl px-4 py-3 overflow-hidden
// 											flex-2'>
// 								<h1 className='font-bold text-xl mb-4'>Score Analysis</h1>
// 								<div className="flex flex-col gap-1">
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Highest Score</p>
// 										<p className='font-extrabold text-xl text-yellow-400'>56</p>
// 									</div>
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Average Score</p>
// 										<p className='font-extrabold text-xl text-white/90'>22</p>
// 									</div>
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Lowest Score</p>
// 										<p className='font-extrabold text-xl text-white/60'>2</p>
// 									</div>
// 								</div>
// 							</div>
// 							<div className='bg-white/4 border border-white/10 w-full rounded-2xl backdrop-blur-2xl px-4 py-3 overflow-hidden
// 											flex-2'>
// 								<h1 className='font-bold text-xl mb-4'>Session Stats</h1>
// 								<div className="flex flex-col gap-1">
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Longest Session</p>
// 										<p className='font-extrabold text-xl text-blue-400'>15:12</p>
// 									</div>
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Shortest Session</p>
// 										<p className='font-extrabold text-xl text-white/90'>6:33</p>
// 									</div>
// 									<div className="flex justify-between">
// 										<p className='font-medium text-lg text-white/70'>Total Playtime</p>
// 										<p className='font-extrabold text-xl text-violet-400'>2h 14m</p>
// 									</div>
// 								</div>
// 							</div>
// 						</div>
