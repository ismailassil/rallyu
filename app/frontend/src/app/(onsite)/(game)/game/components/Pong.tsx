const Pong = () => {
    return (
        <div className="absolute inset-0 flex items-center rounded-xl transition-all duration-200 border shadow-xl border-card bg-neutral-900/70 hover:bg-neutral-900/90 hover:scale-[101%] cursor-pointer [clip-path:polygon(55%_0,100%_0,100%_100%,45%_100%)] group">
