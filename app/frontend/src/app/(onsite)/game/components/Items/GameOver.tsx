...
const GameOver = ({ display, children, tournamentId }: { display: string , children?: ReactNode, tournamentId?: number }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex p-3 gap-2">
                <button
                    onClick={() => tournamentId ? router.replace(`/tournament/stage/${tournamentId}`) : router.push('/game')}
