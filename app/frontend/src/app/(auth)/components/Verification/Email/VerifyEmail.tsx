	...
	return (
		<AnimatedComponent className='w-full max-w-lg p-11 flex flex-col gap-5 select-none' componentKey='verify-email-setup'>
				...
				<NoteBox title='Note' className='bg-blue-500/6 text-blue-400 md:text-sm mt-2'>
					<br></br>Updating this email will replace the existing contact information on your account. <br></br>Please ensure the new information is correct, as it will be used for all future communications and verifications.
				</NoteBox>
		</AnimatedComponent>
	);
}
